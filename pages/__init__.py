...
from mysite.pages.admin import manage_site_data, site_documenation
from mysite.pages.main_pages import new_student_info, home
from mysite.pages.dev_pages import join_team, report_bug

from mysite.pages.courses import view_notes, CISS240, view_assignment, view_quizzes, view_projects

from mysite.pages.student_resources import student_resources
